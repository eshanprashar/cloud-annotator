...
import json
import os
from zoneinfo import ZoneInfo # ADDED THIS LINE DESPITE WARNING BCS WHY NOT
...
class Config(object):
    ...
    AWS_SQS_REQUESTS_QUEUE_NAME = (
        f"arn:aws:sqs:us-east-1:127134666975:{iam_username}_a16_job_requests"
    )

    # AWS_SNS_THAWING_TOPIC
    AWS_SNS_THAWING_TOPIC = (
